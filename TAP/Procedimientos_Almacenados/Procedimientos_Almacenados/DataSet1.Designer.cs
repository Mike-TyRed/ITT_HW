...
namespace Procedimientos_Almacenados {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class UsuarioDataTable : global::System.Data.TypedTableBase<UsuarioRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public UsuarioRow AddUsuarioRow(string Nombre, string Email, int Telf, string Contraseña) {
...
namespace Procedimientos_Almacenados.DataSet1TableAdapters {
    ...
    public partial class UsuarioTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Usuario] WHERE (([IDusuario] = @Original_IDusuario) AND ((@IsNull_Nombre = 1 AND [Nombre] IS NULL) OR ([Nombre] = @Original_Nombre)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Telf = 1 AND [Telf] IS NULL) OR ([Telf] = @Original_Telf)) AND ((@IsNull_Contraseña = 1 AND [Contraseña] IS NULL) OR ([Contraseña] = @Original_Contraseña)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Usuario] ([Nombre], [Email], [Telf], [Contraseña]) VALUES (@No" +
                "mbre, @Email, @Telf, @Contraseña);\r\nSELECT IDusuario, Nombre, Email, Telf, Contr" +
                "aseña FROM Usuario WHERE (IDusuario = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Usuario] SET [Nombre] = @Nombre, [Email] = @Email, [Telf] = @Telf, [Contraseña] = @Contraseña WHERE (([IDusuario] = @Original_IDusuario) AND ((@IsNull_Nombre = 1 AND [Nombre] IS NULL) OR ([Nombre] = @Original_Nombre)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Telf = 1 AND [Telf] IS NULL) OR ([Telf] = @Original_Telf)) AND ((@IsNull_Contraseña = 1 AND [Contraseña] IS NULL) OR ([Contraseña] = @Original_Contraseña)));
SELECT IDusuario, Nombre, Email, Telf, Contraseña FROM Usuario WHERE (IDusuario = @IDusuario)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Procedimientos_Almacenados.Properties.Settings.Default.BConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT IDusuario, Nombre, Email, Telf, Contraseña FROM dbo.Usuario";
        ...
        public virtual int Delete(int Original_IDusuario, string Original_Nombre, string Original_Email, global::System.Nullable<int> Original_Telf, string Original_Contraseña) {
            ...
            if ((Original_Telf.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[6].Value = ((int)(Original_Telf.Value));
            }
            else {
        ...
        public virtual int Insert(string Nombre, string Email, global::System.Nullable<int> Telf, string Contraseña) {
            if ((Nombre == null)) {
            ...
            if ((Telf.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[2].Value = ((int)(Telf.Value));
            }
            else {
        ...
        public virtual int Update(string Nombre, string Email, global::System.Nullable<int> Telf, string Contraseña, int Original_IDusuario, string Original_Nombre, string Original_Email, global::System.Nullable<int> Original_Telf, string Original_Contraseña, int IDusuario) {
            if ((Nombre == null)) {
            ...
            if ((Telf.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[2].Value = ((int)(Telf.Value));
            }
            else {
            ...
            if ((Original_Telf.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[10].Value = ((int)(Original_Telf.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nombre, string Email, global::System.Nullable<int> Telf, string Contraseña, int Original_IDusuario, string Original_Nombre, string Original_Email, global::System.Nullable<int> Original_Telf, string Original_Contraseña) {
            return this.Update(Nombre, Email, Telf, Contraseña, Original_IDusuario, Original_Nombre, Original_Email, Original_Telf, Original_Contraseña, Original_IDusuario);
        }
    }
